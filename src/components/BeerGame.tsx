...
const BeerGame: React.FC = () => {
  return (
    <section id="beergame" className="min-h-screen bg-[#fdf6f1] py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {strategies.map((s, idx) => (
              <div
                key={idx}
                className="bg-white p-6 rounded-lg border border-yellow-200 hover:shadow-md"
              >
        ...
        <div className="mb-16">
          ...
          <p className="text-sm text-gray-600 mt-4">
            <strong>Rodada 1:</strong> Custos elevados pela decisão da Fábrica de manter
            estoque excessivo.
            <br />
            <strong>Rodada 2:</strong> Pior desempenho, efeito chicote disparou custos (67% do
            total).
            <br />
        ...
        <div className="bg-white rounded-2xl p-8 border border-yellow-200">
          ...
          <p className="text-gray-700 leading-relaxed">
            A dinâmica mostrou os desafios de gerir uma cadeia de suprimentos. O{" "}
            <strong>Efeito Chicote</strong> revelou o grande impacto da falta de comunicação e
            previsibilidade. A gestão de estoques se mostrou essencial para equilibrar custos e
            nível de atendimento.
            <br />
            <br />
            Para a indústria de alimentos, os desafios são ainda maiores devido à perecibilidade,
            validade, cadeia do frio e rastreabilidade. A lição central é clara:{" "}
            <strong>gerenciar informação é tão importante quanto gerenciar materiais</strong>.
            <br />
            <br />
            A colaboração e a visão sistêmica entre todos os elos da cadeia são fundamentais
